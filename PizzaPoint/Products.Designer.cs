...
namespace PizzaPoint.ProductsTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Products] WHERE (([ProductId] = @Original_ProductId) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_ProductPrice = 1 AND [ProductPrice] IS NULL) OR ([ProductPrice] = @Original_ProductPrice)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Products] ([ProductName], [ProductPrice], [ProductImage]) VALUES (@P" +
                "roductName, @ProductPrice, @ProductImage);\r\nSELECT ProductId, ProductName, Produ" +
                "ctPrice, ProductImage FROM Products WHERE (ProductId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Products] SET [ProductName] = @ProductName, [ProductPrice] = @ProductPrice, [ProductImage] = @ProductImage WHERE (([ProductId] = @Original_ProductId) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_ProductPrice = 1 AND [ProductPrice] IS NULL) OR ([ProductPrice] = @Original_ProductPrice)));
